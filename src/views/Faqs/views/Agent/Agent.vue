<template>
  <BaseCard>
    <div class="faq">
      <div class="question">Can I list a property on Homefound if it is already listed for sale on REA or Domain?</div>
      <div class="answer">No.</div>
    </div>
    <div class="faq">
      <div class="question">Amet lorem ipsum dolor sit?</div>
